...
<body style="background-color:#f0f0f0;padding:0 20px;">
	<div style="background-color:#f0f0f0;">
		...
		<div style="margin:0px auto;max-width:460px;height:30px;"></div>
						...
						<td style="direction:ltr;font-size:0px;padding:0px;text-align:center;">
							...
							<div style="background:#FFFFFF;background-color:#FFFFFF;margin:0px auto;border-radius:8px;max-width:460px;">
								<table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#FFFFFF;background-color:#FFFFFF;width:100%;border-radius:8px;">
									<tbody>
                                        <tr>
                                        <div style="height:10px;background-color:#dd5353;border-top-left-radius: 5px; border-top-right-radius: 5px;margin-bottom:20px;"></div>
                                        </tr>
										<tr>
											<td style="direction:ltr;font-size:0px;padding:20px 0;padding-bottom:25px;padding-left:10px;padding-right:10px;padding-top:0;text-align:center;">
				...
				<tbody>
					<tr>
						<td style="direction:ltr;font-size:0px;padding:20px 0;padding-top:8px;text-align:center;">
							<!--[if mso | IE]><table role="presentation" border="0" cellpadding="0" cellspacing="0"><tr><td class="" width="460px" ><table align="center" border="0" cellpadding="0" cellspacing="0" class="" style="width:460px;" width="460" ><tr><td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
							<div style="background:#f0f0f0;background-color:#f0f0f0;margin:0px auto;max-width:460px;">
